...
class DatasetCatalog(object):
    ...
    DATASETS = {
        "anet_cap_train": {
            "feature_path": os.path.join(ANET_FEATURES_PATH, 'training'),
            "ann_file_path": os.path.join(ANNOTATIONS_PATH, 'anet-cap/ANetCap_training_tokens_w_objects.json'),
            "embeddings_path": os.path.join(EMBEDDINGS_PATH, 'glove.840B.300d.txt'),
            "obj_features": os.path.join(ANET_OBJ_FEATURES_PATH, 'training'),
        },
        "anet_cap_test": {
            "feature_path": os.path.join(ANET_FEATURES_PATH, 'validation'),
            "ann_file_path": os.path.join(ANNOTATIONS_PATH, 'anet-cap/ANetCap_validation_tokens_w_objects.json'),
            "embeddings_path":os.path.join(EMBEDDINGS_PATH, 'glove.840B.300d.txt'),
            "obj_features": os.path.join(ANET_OBJ_FEATURES_PATH, 'validation'),
        },
        "charades_sta_train": {
        ...
        "youcookII_train" : {
            ...
            # "llama_emb_path": YOUCOOKII_LLAMA_EMB_PATH
            },
